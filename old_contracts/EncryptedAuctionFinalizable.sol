...
/// @title EncryptedAuctionFinalizable
/// @author Gvantsa Vakhtangishvili
/// @notice Finalizable encrypted auction prototype with encrypted bids, encrypted highest bid, and encrypted winner id.
contract EncryptedAuctionFinalizable is ZamaEthereumConfig {
    ...
    /// @notice Creates an encrypted auction with winner tracking and finalization.
